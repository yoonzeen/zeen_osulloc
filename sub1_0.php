...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 프레시 유자 그린 티 | Jeju Osulloc </title>
    ...
    /* ########## section0 ########## */
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #leftWrap {width:40%; margin-right:10%; float:left;}
          ...
          #leftWrap .imgIntro {width:100%; height:300px;  overflow:hidden; outline:1px solid #ccc; }
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .desc .price {display:block; width:100%; font-size:20px; padding:20px 0 10px; color:#333; }
            #rightWrap .linethrough {display:block; width:250px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
    ...
    /* ########## section1 ########## */
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:240px; margin:70px auto 0; position:relative;}
        ...
        #info1 {width:100%; text-align:center; margin:0 auto; background-color:rgba(246,244,242,1); padding:80px 0;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="프레시 유자 그린 티">프레시 유자 그린 티</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="프레시 유자 그린 티">프레시 유자 그린 티</strong>
              <em>Fresh Citron Green Tea</em>
              녹차 슬러쉬에 유자셔벗이 층을 이룬 상큼한 음료.
              <span class="price"><span id="price_th">6</span>,<span id="price_rem">500</span>원</span><input type="text" id="price" name="price" title="price" value="6500" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             <span class="desctitle">TEA ADE</span>
             <span class="desc">프레시 유자 그린 티는, 오설록 제주 차밭의 유기농 티 베이스의 아이스 음료인 TEA ADE 입니다. </span>
          </p>
        </div>
        <div id="info1">
          <img src="img/ade1.png" alt="ade"/>
          <!--
        ...
        <div id="photos">
          <p class="imgArea">
            ...
            <span>
              <img src="img/m5_0_real.jpg" alt="img"/>
            </span>
            <span>
