...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 그린티 아이스크림 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:230px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
      ...
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            /* #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-position:center bottom; background-size:100%; background-repeat:no-repeat;} */
...
<?php } echo"<meta http-equiv='Refresh' content='60; url=logout.php'/>";?>
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.html" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="그린티 아이스크림">그린티 아이스크림</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="그린티 아이스크림">그린티 아이스크림</strong>
              <em>Green Tea Ice-cream</em>
              오설록 다원의 유기농 녹차로 만든 오설록 대표 아이스크림.
              <span class="price"><span id="price_th">5</span>,<span id="price_rem">000</span>원</span><input type="text" id="price" name="price" title="price" value="5000" style="display:none;"/>
              <span class="linethrough"></span>
            </p><!-- parseInt(document.getElementById("price_th") * 1000 + document.getElementById("price_rem")) -->
            <p class="numbering">
              <label for="num">몇 개를 드시고 싶으신가요?</label>
            ...
            <p class="calcul">
              <span>총 <input id="total1" type="text" name="total1" title="총 금액" readonly="readonly" autocomplete="off"/>,<input id="total2" type="text" name="total2" title="총 금액" readonly="readonly" autocomplete="off"/> 원</span><input type="text" id="total" name="total" title="total" style="display:none;"/>
            </p>
            <!-- <p class="like">
      ...
      <section id="section1">
        ...
        <div id="infoHeader">
          <h3>그린티 아이스크림</h3>
          <em>Green Tea Icecream</em>
        </div>
        <div id="info">
          <p class="descArea0">
             <span class="desctitle">TEA FOOD</span>
             <span class="desc">그린티 아이스크림은, 오설록 제주 차밭의 신선함을 그대로 담은 TEA FOOD 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m_tea1.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m_tea11.jpg" alt="img"/>
            </span>
            <span>
  ...
  function totalcal(){
	...
	setTimeout(function(){
		var i = confirm(teaname.title+"을 "+num.value+"개 선택하셔서 \n"+total1.value+","+total2.value+"원 입니다.");
		if(i == true){
