...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 프레시 한라봉 그린 티 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:275px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="프레시 한라봉 그린 티">프레시 한라봉 그린 티</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="프레시 한라봉 그린 티">프레시 한라봉 그린 티</strong>
              <em>Fresh Hanrabong Tangerine Green Tea</em>
              녹차 슬러쉬에 한라봉 퓨레가 곁들여진 달콤한 음료.
              <span class="price"><span id="price_th">6</span>,<span id="price_rem">500</span>원</span>
			...
			<input type="text" id="price" name="price" title="price" value="6500" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">프레시 한라봉 그린 티는, 오설록 제주 차밭의 유기농 티 베이스의 아이스 음료인 TEA ADE 입니다. </span>
          </p>
        </div>
        <div id="info1">
