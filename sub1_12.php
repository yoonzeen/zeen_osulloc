...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 제주 아일랜드 그린 티 | Jeju Osulloc </title>
      ...
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-image:url("img/m3_0_ing.jpg"); background-position:center bottom; background-size:100%; background-repeat:no-repeat;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="제주 아일랜드 그린 티">제주 아일랜드 그린 티</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="제주 아일랜드 그린 티">제주 아일랜드 그린 티</strong>
              <em>Jeju Island Green Tea</em>
              부제주의 화사하고 향긋한 봄꽃을 담은 녹차.
              <span class="price"><span id="price_th">8</span>,<span id="price_rem">000</span>원</span>
			...
			<input type="text" id="price" name="price" title="price" value="8000" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">제주 아일랜드 그린 티는, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 차인 TEA 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m_tea10.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m_tea7.jpg" alt="img"/>
            </span>
            <span>
