...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 롤케익 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:100px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="롤 케익">롤 케익</a>
            </p>
            <p class="imgIntro">
              <img src="img/m4_1.png" alt="롤 케익"/>
            </p>
          </div>
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="롤 케익">롤 케익</strong>
              <em>Roll Cake</em>
              마스카포네 치즈크림이 샌딩된 오설록 대표 베이커리.
              <span class="price"><span id="price_th">5</span>,<span id="price_rem">500</span>원</span>
			...
			<input type="text" id="price" name="price" title="price" value="5500" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">롤 케익은, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 차와 잘 어울리는 TEA FOOD 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m4_1_real1.jpg" alt="img"/>
            </span>
            <span>
