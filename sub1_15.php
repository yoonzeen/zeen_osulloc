...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 다쿠아즈 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:120px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
...
<?php } echo"<meta http-equiv='Refresh' content='60; url=logout.php'/>";?>
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="다쿠아즈">다쿠아즈</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="다쿠아즈">다쿠아즈</strong>
              <em>Dacquoise</em>
              차와 잘 어울리는 바삭한 그린티 다쿠아즈.
              <span class="price"><span id="price_th">2</span>,<span id="price_rem">500</span>원</span>
			...
			<input type="text" id="price" name="price" title="price" value="2500" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">다쿠아즈는, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 차와 잘 어울리는 TEA FOOD 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m4_2_real.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m4_2_real1.jpg" alt="img"/>
            </span>
            <span>
  ...
  function totalcal(){
	...
	setTimeout(function(){
		var i = confirm(teaname.title+"를 "+num.value+"개 선택하셔서 \n"+total1.value+","+total2.value+"원 입니다.");
		if(i == true){
