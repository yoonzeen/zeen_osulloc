...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 세작 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:60px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
      ...
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-image:url("img/m0_1_ing.jpg"); background-position:center bottom; background-size:100%; background-repeat:no-repeat;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="세작">세작</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="세작">세작</strong>
              <em>Sejak Green Tea</em>
              제주 차밭의 어린 찻잎으로 만든 작설차.
              <span class="price"><span id="price_th">8</span>,<span id="price_rem">500</span>원</span>
			...
			<input type="text" id="price" name="price" title="price" value="8500" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">세작은, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 녹차인 TEA 입니다. </span>
             <span class="real"></span>
          </p>
        </div>
        <div id="info1">
          <img src="img/sejak.png" alt="sejak"/>
          <!--
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m0_1_real0.jpg" alt="img"/>
            </span>
            <span>
