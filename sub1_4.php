...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 삼다연 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:90px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
      ...
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-image:url("img/m0_2_ing.jpg"); background-position:center bottom; background-size:100%; background-repeat:no-repeat;}
 ...
 <body>
  <div id="wrap">
    <header id="header">
      <div id="lHeader">
        <h1>
          <a href="index_html5.php" title="osulloc">
...
<?php } echo"<meta http-equiv='Refresh' content='60; url=logout.php'/>";?>
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="삼다연">삼다연</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="삼다연">삼다연</strong>
              <em>Samdayeon Fermented Tea</em>
              부드러운 단향미가 가득한 반발효차.
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">삼다연은, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 차인 TEA 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            ...
            <span>
              <img src="img/m0_2_real.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m_tea12.jpg" alt="img"/>
            </span>
          </p>
        </div>
        <div id="info1">
  	...
  	<footer id="footerWrap">
		...
		<div id="footer">
			<div class="leftWrap">
				<p class="img">
				  <a href="index_html5.php" title="오설록"><img src="img/logo_black.png" alt="오설록 로고"/></a>
				</p>
			</div>
			<div class="rightWrap">
				<ul>
  ...
  function langClick(){
    ...
    if (lang.value == "en"){
      ...
      location.href="index_html5.html"
    }
  }
  function totalcal(){
