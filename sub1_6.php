...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 제주 난꽃향 그린 티 | Jeju Osulloc </title>
      ...
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-image:url("img/m0_3_ing.jpg"); background-position:center bottom; background-size:100%; background-repeat:no-repeat;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="제주 난꽃향 그린 티">제주 난꽃향 그린 티</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="제주 난꽃향 그린 티">제주 난꽃향 그린 티</strong>
              <em>Jeju Orchid Green Tea</em>
              제주한란의 은은한 향이 깃든 오리엔탈 녹차
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">제주 난꽃향 그린티는, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 차인 TEA 입니다. </span>
