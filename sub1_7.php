...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 녹차 오프레도 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:180px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="녹차 오프레도">녹차 오프레도</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="녹차 오프레도">녹차 오프레도</strong>
              <em>Green Tea O Fredo</em>
              녹차쉐이크에 녹차아이스크림을 얹은 오설록 인기메뉴.
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             ...
             <span class="desc">녹차 오프레도는, 다양한 재료가 들어간 쉐이크에 부드러운 아이스크림 토핑을 얹은 아이스 음료인 O FREDO 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            ...
            <span>
              <img src="img/m_tea13.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m2_0_real.jpg" alt="img"/>
            </span>
          </p>
        </div>
      </section>
