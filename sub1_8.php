...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 제주 영귤 밀크 티 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .linethrough {display:block; width:220px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
      ...
      #section1 {width:100%; margin:150px auto 0; }
        ...
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-image:url("img/m1_1_ing.jpg"); background-position:center bottom; background-size:100%; background-repeat:no-repeat;}
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.php" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="제주 영귤 밀크 티">제주 영귤 밀크 티</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="제주 영귤 밀크 티">제주 영귤 밀크 티</strong>
              <em>Jeju Tangerine Milk Tea</em>
              오설록의 블렌디드티 삼다연 차를 베이스로 한 밀크티.
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             <span class="desctitle">TEA LATTE</span>
             <span class="desc">제주 영귤 밀크 티는, 오설록 제주 차밭의 유기농 차에 우유를 블렌딩한 부드러운 풍미의 TEA LATTE 입니다. </span>
             <span class="real"></span>
          </p>
        </div>
        <div id="info1">
          <img src="img/latte1.png" alt="latte"/>
          <!--
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m1_0_real.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m0_2_real.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m1_0_real2.jpg" alt="img"/>
            </span>
          </p>
        </div>
      </section>
