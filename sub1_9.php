...
<html lang="ko">
 <head>
  <meta charset="utf-8"/>
  <title> 티 카페 - 귤꽃향을 품은 우잣담 | Jeju Osulloc </title>
      ...
      #menuIntro:after {content:""; display:block; clear:both;}
        ...
        #rightWrap {width:50%; float:left;}
          #rightWrap .desc {width:100%; margin:0 auto; font-family:"arita-buriL"; font-size:14px; position:relative;}
            ...
            #rightWrap .desc em {display:block; width:100%; padding:65px 0 15px; /* margin값과 strong의 높이값 합친 것이 padding-top */ font-size:16px; color:#999; }
            #rightWrap .desc .price {display:block; width:100%; font-size:20px; padding:10px 0; color:#333; }
            #rightWrap .linethrough {display:block; width:270px; height:13px; position:absolute; left:0; top:35px; background-color:rgba(145,190,120,0.3); z-index:0;}
    ...
    /* ########## section1 ########## */
      #section1 {width:100%; margin:150px auto 0; }
        #infoHeader {width:800px; margin:0 auto; position:relative; }
          ...
          #infoHeader em {width:100%; text-align:center;  font-style:normal; font-family:"arita-buriL"; font-size:40px; color:rgba(150,150,150,0.1); display:block;  position:absolute; left:0; top:140px; }
        #info {width:800px; margin:0 auto; }
          #info .descArea0 {width:100%; height:215px; margin:70px auto 0; position:relative;}
            ...
            #info .descArea0 .real { display:block; margin:0 auto; width:300px; height:150px; background-image:url("img/m0_4_ing.jpg"); background-position:center bottom; background-size:100%; background-repeat:no-repeat;}
        ...
        #info1 {width:100%; text-align:center; margin:0 auto; background-color:rgba(246,244,242,1);}
          #info1 img {width:100%;}
...
<?php } echo"<meta http-equiv='Refresh' content='60; url=logout.php'/>";?>
    ...
    <div id="mobQuickMenu">
      ...
      <section id="section0">
        ...
        <div id="menuIntro">
          <div id="leftWrap">
            <p class="smallnav">
              <span class="smallnavheader">∙</span><a href="sub1.html" title="티 카페" class="sub1">티 카페</a>&gt;<a href="#none" title="귤꽃향을 품은 우잣담">귤꽃향을 품은 우잣담</a>
            </p>
            <p class="imgIntro">
          ...
          <div id="rightWrap">
            <p class="desc">
              <strong id="teaname" title="귤꽃향을 품은 우잣담">귤꽃향을 품은 우잣담</strong>
              <em>Stone fence enveloped in Tangerine flower</em>
              제주 귤꽃향에 감귤의 상큼함을 더한 블렌디드 티
              <span class="price"><span id="price_th">7</span>,<span id="price_rem">000</span>원</span>
			...
			<input type="text" id="price" name="price" title="price" value="7000" style="display:none;"/>
      ...
      <section id="section1">
        ...
        <div id="info">
          <p class="descArea0">
             <span class="desctitle">TEA</span>
             <span class="desc">귤꽃향을 품은 우잣담은, 오설록 제주 차밭의 신선함을 그대로 담은 유기농 차인 TEA 입니다. </span>
        ...
        <div id="photos">
          <p class="imgArea">
            <span>
              <img src="img/m_tea8.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m_tea0.jpg" alt="img"/>
            </span>
            <span>
              <img src="img/m_tea2.jpg" alt="img"/>
            </span>
          </p>
        </div>
        <div id="info1">
          <img src="img/intro2.jpg" alt="이미지"/>
          <!-- <video controls><source src="video/tea1.mp4" title="video"/></video> -->
        </div>
      </section>
  ...
  function totalcal(){
	...
	setTimeout(function(){
		var i = confirm(teaname.title+"을 "+num.value+"잔 선택하셔서 \n"+total1.value+","+total2.value+"원 입니다.");
		if(i == true){
